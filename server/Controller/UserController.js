...
exports.registerUser = asyncHandler(async (req, res, next) => {
  ...
  if (!username || !email || !password) {
    return next(new ErrorHandler("username, email, password required ", 400));
  }
...
exports.verifyOTP = asyncHandler(async (req, res, next) => {
  ...
  if ( !email || !OTP) {
    return next(new ErrorHandler(" email, OTP  required ", 400));
  }
...
console.log("fromn verify user = ", user)
  if (!user) {
